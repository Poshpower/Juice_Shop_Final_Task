Feature: Shopping
This feature contains scenarios about adding credit cards and making payments for Orders
...
Scenario: Make a purchase
        ...
        And I click on 'Orders and Payment' option again
        ...
        And I add 'Eggfruit Juice' to basket and checkout
